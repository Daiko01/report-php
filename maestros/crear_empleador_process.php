...
$sql = "INSERT INTO empleadores (rut, nombre, empresa_sistema, caja_compensacion_id, mutual_seguridad_id, tasa_mutual_decimal) 
                VALUES (:rut, :nombre, :empresa, :caja_id, :mutual_id, :tasa)";
