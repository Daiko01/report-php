                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        if (isset($_SESSION['user_nombre'])) {
                            ...
                            // Lógica de abreviación: Si hay más de 2 partes (ej: Nombre Apellido1 Apellido2)
                            if (count($partes) >= 3) {
                                $apellido2 = array_pop($partes); // Saca el último
                                $apellido1 = array_pop($partes); // Saca el penúltimo
                                $nombres = implode(' ', $partes); // El resto son nombres
                                $nombre_mostrar = $nombres . ' ' . $apellido1 . ' ' . substr($apellido2, 0, 1) . '.';
                            }
                            ...
                            if (isset($_SESSION['user_role'])) {
                                ...
                                echo " <small class='text-muted'>($rol)</small>";
                            }
                        } else {
                            echo 'Usuario';
                        }
